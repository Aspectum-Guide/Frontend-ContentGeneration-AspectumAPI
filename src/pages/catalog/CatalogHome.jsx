...
const CATALOG_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { to: '/catalog/booking-setup', title: 'Настройка продаж', description: 'Дашборд: типы билетов, слоты, цены, покрытие', icon: '🧭' },
      ...
      { to: '/catalog/ticket-types', title: 'Типы билетов', description: 'Каталог типов с кодами', icon: '🎟️' },
      { to: '/catalog/slot-availabilities', title: 'Слоты', description: 'Доступные слоты по времени', icon: '🕒' },
      { to: '/catalog/ticket-prices', title: 'Цены слотов', description: 'Цены по слотам и типам', icon: '💶' },
      { to: '/catalog/base-prices', title: 'Базовые цены', description: 'Fallback-цены для ценового движка', icon: '💰' },
      { to: '/catalog/pricing-rules', title: 'Правила цен', description: 'Цены по дням, датам и времени', icon: '📋' },
    ],
  },
  {
    id: 'subscription',
