...
export default function SessionWizardCityStep({
  ...
  const localeLabel =
    currentLocale.lang?.toUpperCase() ||
    activeLocale.split('-')[0].toUpperCase();
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Название, описание, страна, координаты и фото города
        </p>
      </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`text-xs ${
                      isActiveDraft ? 'text-blue-700 font-medium' : 'text-gray-700'
                    }`}
                  >
        ...
        <main className="flex-1 min-w-0 space-y-4">
          <div className="grid grid-cols-2 gap-5">
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Описание ({localeLabel})
                </label>
                <textarea
                  value={currentLocale.description || ''}
                  onChange={(e) => onUpdateLocaleField('description', e.target.value)}
                  rows={4}
                  placeholder={`Описание города на ${
                    currentLocale.langName?.toLowerCase() || 'языке'
                  }`}
